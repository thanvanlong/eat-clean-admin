...
import {createProduct, getCategory} from "../../../../../../redux/features/productSlice";
                       ...
                       <Form onFinish={handleSubmit}>
                           ...
                           <div className={'mt-3 w-full flex'}>
                               <div className={'w-1/2'}>
                                   ...
                                   >
                                       <InputNumber min={1000} defaultValue={0} step={1000} className={'mt-1 w-11/12'}/>
                                   </Form.Item>
                               </div>
                               <div className={'w-1/2'}>
                                   ...
                                   >
                                       <InputNumber min={1} defaultValue={0} step={1} className={'mt-1 w-11/12'}/>
                                   </Form.Item>
                               </div>
                           </div>
                           <div className={'w-full mt-3'}>
